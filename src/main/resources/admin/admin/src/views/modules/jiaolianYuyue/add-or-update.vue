    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="jiaolianShanchang">
                        <el-input v-model="jiaolianForm.jiaolianShanchang"
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="账户状态" prop="jinyongValue">
                        <el-input v-model="jiaolianForm.jinyongValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约缘由" prop="jiaolianYuyueText">
                        <el-input type="textarea"  :readonly="ro.jiaolianYuyueText" v-model="ruleForm.jiaolianYuyueText" placeholder="预约缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianYuyueText" label="预约缘由" prop="jiaolianYuyueText">
                            <span v-html="ruleForm.jiaolianYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jiaolianYuyueTime"  class="input" label="预约日期" prop="jiaolianYuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianYuyueTime" label="预约日期" prop="jiaolianYuyueTime">
