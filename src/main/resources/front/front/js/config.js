...
var centerMenu = [
    ...
    ,{
        name: '器具收藏',
        url: '../qijuCollection/list.html'
    }
    ,{
        name: '器具订单',
        url: '../qijuOrder/list.html'
    }
    ,{
        name: '赛道收藏',
        url: '../saidaoCollection/list.html'
    }
    ,{
        name: '赛道预约',
        url: '../saidaoYuyue/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '滑雪器具',
        url: './pages/qiju/list.html'
    },
    {
        name: '赛道',
        url: './pages/saidao/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/huaxuechang/admin/dist/index.html#/login";
